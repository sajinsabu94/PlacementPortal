                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <div class="resume-image-border" style="float:right;">
                            <img src="./student-view/myinfo/<?php echo $ProfileImage; ?>" class="img-responsive" style="width:200px; height:200px;">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row" style="margin-left:20px; margin-right:20px;">
                            ...
                            foreach ($doc_tbl as $value) {
                                $FileID = $value[0];
                                $DocumentName = $value[2];
                                $FileIDenc = encrypt_decrypt("encrypt", $FileID);
                                ?>
                                    <div class="col-xs-4">
                                        <a href="#" onclick="MyWindow=window.open('./student-view/myinfo/myinfoadd.php?DocID=<?php echo $FileIDenc; ?>')"><?php echo $DocumentName; ?></a>                                        
                                    </div>
                                    <?php
                            }
                            ?>
