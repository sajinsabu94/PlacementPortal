...
<head>
    ...
    <!-- Basic -->
    <title>PlacementCell | Active Company</title>
            ...
            <div class="container">
                ...
                <table class="table segment table-hover">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td width="20%"><a target="_blank" href="#" onClick="MyWindow=window.open('../companyprofile.php?id=<?php echo $CompanyID; ?>','MyWindow',width=600,height=300); return false;"><?php echo $CompanyName; ?></a></td>
